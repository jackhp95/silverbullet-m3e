 ...
 * directory straight off disk (see the Makefile's `build-e2e` comment), so
 * this swap is visible to an already-running server without a rebuild —
 * verified by hand before writing this test.
 *
