...
export default function highlightStyles() {
  ...
  return HighlightStyle.define([
    ...
    { tag: t.emphasis, class: "sb-emphasis italic" },
    { tag: t.strong, class: "sb-strong font-black" },
    ...
    { tag: t.keyword, class: "sb-keyword font-bold" },
    ...
    { tag: ct.HorizontalRuleTag, class: "sb-hr font-bold" },
    ...
    { tag: ct.SubscriptTag, class: "sb-sub align-sub text-[smaller]" },
    { tag: ct.SuperscriptTag, class: "sb-sup align-super text-[smaller]" },

    { tag: ct.DirectiveMarkTag, class: "sb-directive-mark font-bold" },
    { tag: ct.DirectiveTag, class: "sb-directive font-bold" },
  ]);
}
