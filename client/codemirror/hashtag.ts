...
// browser-only app root, alongside its existing `@m3e/web/theme`/
// `@m3e/web/snackbar` imports) — custom-element registration is global, so
// one import there covers every module that renders `<m3e-assist-chip>`.
